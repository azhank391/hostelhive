...
export default function HostelStudentsPage() {
  ...
  const canUpdateStudents =
    hasPermission("student_update") || hasPermission("student_create"); // Allow create permission for updates
  ...
  const [selectedStudent, setSelectedStudent] =
    useState<StudentWithRoom | null>(null);
  ...
  const handleRoomAllocation = useCallback(
  ...
  const handleRoomDeallocation = useCallback(
    async (studentId: string) => {
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Failed to deallocate room";
  ...
  const openRoomAllocationModal = useCallback(
    async (student: StudentWithRoom) => {
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">
            Loading students for hostel: {hostelId}
          </p>
          <Button
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">
            Contact your administrator to get access to student management
            features.
          </p>
        </div>
      </div>
                          ...
                          <div className="relative inline-block text-left">
                            ...
                            >
                              ...
                              {!student.roomNumber && canAllocateRooms && (
                                <option value="allocate">Allocate Room</option>
                              )}
                              {student.roomNumber && canDeallocateRooms && (
                                <option value="deallocate">Remove Room</option>
                              )}
                              {canDeleteStudents && (
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                A default password (123456) will be automatically set for the
                student.
              </p>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      Students will be prompted to change this password on first
                      login
                    </p>
                  </div>
                </div>
