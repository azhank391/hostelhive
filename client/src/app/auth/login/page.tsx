...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (errorParam === "unauthorized") {
      ...
      setError(
        "You have been successfully logged out. Please sign in again to continue."
      );
    ...
    if (planParam) {
      try {
        localStorage.setItem("HOSTELHIVE_SELECTED_PLAN", planParam);
      } catch {}
    }
  }, [searchParams]);
        ...
        try {
          const plan =
            typeof window !== "undefined"
              ? localStorage.getItem("HOSTELHIVE_SELECTED_PLAN")
              : null;
                ...
                <Link
                  href={
                    searchParams?.get("plan")
                      ? `/auth/register-owner?plan=${encodeURIComponent(
