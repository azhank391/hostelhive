...
router.get(
  ...
  verifyToken,
  requirePermission("staff_create"),
  rbacController.getGranularPermissions
);
 ...
 */
router.get(
  "/permissions/:permissionName/dependencies",
  verifyToken,
  requirePermission("staff_create"),
  rbacController.getPermissionDependencies
);
...
router.post(
  ...
  verifyToken,
  requirePermission("staff_create"),
  rbacController.validatePermissionAssignment
);
 ...
 */
router.get(
  "/pages/:pageName/dependencies",
  verifyToken,
  requirePermission("staff_create"),
  rbacController.getPageDependencies
);
 ...
 */
router.post(
  "/permissions/multiple-dependencies",
  verifyToken,
  requirePermission("staff_create"),
  rbacController.getMultipleDependencies
);
 ...
 */
router.get(
  "/hostels/:hostelId/roles",
  verifyToken,
  requirePermission("staff_read"),
  rbacController.getCustomRoles
);
 ...
 */
router.put(
  "/hostels/:hostelId/roles/:roleId",
  verifyToken,
  requirePermission("staff_update"),
  rbacController.updateCustomRole
);
 ...
 */
router.post(
  "/hostels/:hostelId/users/:userId/assign-role",
  verifyToken,
