...
const { validateHostelAccess } = require('../middleware/hostelAccessMiddleware');
 ...
 */
router.get('/', verifyToken, requirePermission('hostel_read'), hostelController.getUserHostels);
 ...
 */
router.post('/', verifyToken, requireOwnerOrPermission('hostel_create'), hostelController.createHostel);
 ...
 */
router.get('/:hostelId', requirePermission('hostel_read'), hostelController.getHostelDetails);
 ...
 */
router.put('/:hostelId', requirePermission('hostel_update'), hostelController.updateHostel);
 ...
 */
router.delete('/:hostelId', requirePermission('hostel_delete'), hostelController.deleteHostel);
 ...
 * @access Private (Users with hostel_read permission)
 */
router.get('/:hostelId/dashboard', requirePermission('hostel_read'), hostelController.getDashboardMetrics);
 ...
 */
router.get('/:hostelId/stats', requirePermission('hostel_stats_read'), adminController.getHostelStats);
 ...
 */
router.get('/:hostelId/stats', requirePermission('hostel_read'), adminController.getHostelStats);
 ...
 */
router.get('/:hostelId/visitors', requirePermission('visitor_read'), adminController.getAllVisitorLogs);
 ...
 */
router.post('/:hostelId/visitors', requirePermission('visitor_create'), adminController.createVisitorLog);
 ...
 */
router.put('/:hostelId/visitors/:visitorId', requirePermission('visitor_update'), adminController.updateVisitorLog);
 ...
 */
router.delete('/:hostelId/visitors/:visitorId', requirePermission('visitor_delete'), adminController.deleteVisitorLog);
 ...
 */
router.post('/:hostelId/visitors/:visitorId/checkout', requirePermission('visitor_checkout'), adminController.checkoutVisitor);
 ...
 */
router.get('/:hostelId/students', requirePermission('student_read'), adminController.getAllStudents);
 ...
 */
router.post('/:hostelId/students', requirePermission('student_create'), adminController.createStudent);
 ...
 */
router.put('/:hostelId/students/:studentId', requirePermission('student_update'), adminController.updateStudent);
 ...
 */
router.delete('/:hostelId/students/:studentId', requirePermission('student_delete'), adminController.deleteStudent);
 ...
 */
router.get('/:hostelId/complaints', requirePermission('complaint_read'), adminController.getAllComplaints);
 ...
 */
router.post('/:hostelId/complaints', requirePermission('complaint_create'), adminController.createComplaint);
 ...
 */
router.post('/:hostelId/complaints/:complaintId/resolve', requirePermission('complaint_resolve'), adminController.resolveComplaint);
 ...
 */
router.put('/:hostelId/complaints/:complaintId/status', requirePermission('complaint_update'), adminController.updateComplaintStatus);
 ...
 */
router.delete('/:hostelId/complaints/:complaintId', requirePermission('complaint_delete'), adminController.deleteComplaint);
 ...
 */
router.get('/:hostelId/rooms', requirePermission('room_read'), adminController.getAllRooms);
 ...
 */
router.post('/:hostelId/rooms', requirePermission('room_create'), adminController.createRoom);
 ...
 */
router.put('/:hostelId/rooms/:roomId', requirePermission('room_update'), adminController.updateRoom);
 ...
 */
router.delete('/:hostelId/rooms/:roomId', requirePermission('room_delete'), adminController.deleteRoom);
 ...
 */
router.get('/:hostelId/rooms/:roomId/students', requirePermission('room_allocation_read'), adminController.getRoomStudents);
 ...
 */
router.post('/:hostelId/room-allocations', requirePermission('room_allocate'), adminController.allocateRoom);
 ...
 */
router.delete('/:hostelId/room-allocations/:allocationId', requirePermission('room_deallocate'), adminController.deallocateRoom);
 ...
 */
router.get('/:hostelId/wardens', requirePermission('warden_read'), adminController.getAllWardens);
 ...
 */
router.post('/:hostelId/wardens', requirePermission('warden_create'), adminController.createWarden);
 ...
 */
router.put('/:hostelId/wardens/:wardenId', requirePermission('warden_update'), adminController.updateWarden);
 ...
 */
router.delete('/:hostelId/wardens/:wardenId', requirePermission('warden_delete'), adminController.deleteWarden);
 ...
 */
router.get('/:hostelId/staff', requirePermission('role_read'), adminController.getAllStaff);
 ...
 */
router.post('/:hostelId/staff', requirePermission('role_create'), adminController.createStaff);
 ...
 */
router.put('/:hostelId/staff/:staffId', requirePermission('role_update'), adminController.updateStaff);
 ...
 */
router.delete('/:hostelId/staff/:staffId', requirePermission('role_delete'), adminController.deleteStaff);
 ...
 * @access Private (Users with role_update permission)
 */
router.patch('/:hostelId/staff/:staffId/status', requirePermission('role_update'), adminController.toggleStaffStatus);
