...
const PERMISSION_DEFINITIONS = {
  ...
  'role_delete': {
    ...
    category: 'staff',
    isHighPrivilege: true,
    warning: 'Allows deletion of custom roles. Affects all staff with this role.'
  },
...
module.exports = {
  ...
  getPermissionDefinition: (permissionName) => PERMISSION_DEFINITIONS[permissionName] || null,
