...
const PERMISSION_DEFINITIONS = {
  // Hostel
  hostel_read: {
    displayName: "Read Hostel",
    dependencies: [],
    category: "hostel",
  },
  hostel_create: {
    displayName: "Create Hostel",
    dependencies: [],
    category: "hostel",
    isHighPrivilege: true,
  },
  hostel_update: {
    displayName: "Update Hostel",
    dependencies: ["hostel_read"],
    category: "hostel",
  },
  hostel_delete: {
    displayName: "Delete Hostel",
    dependencies: ["hostel_read"],
    category: "hostel",
    isHighPrivilege: true,
  },
  hostel_settings_update: {
    displayName: "Update Hostel Settings",
    dependencies: ["hostel_read"],
    category: "hostel",
    isHighPrivilege: true,
  },
  view_hostel_stats: {
    displayName: "View Hostel Stats",
    dependencies: ["hostel_read"],
    category: "hostel",
  },
  ...
  room_allocation_read: {
    displayName: "View Room Allocations",
    dependencies: ["room_read"],
    category: "rooms",
  },
  room_allocation_create: {
    displayName: "Allocate Rooms",
    dependencies: ["room_read", "room_allocation_read"],
    category: "rooms",
  },
  room_allocation_update: {
    displayName: "Update Room Allocation",
    dependencies: ["room_allocation_read"],
    category: "rooms",
  },
  ...
  manage_student_rooms: {
    displayName: "Manage Student Rooms",
    dependencies: ["student_read", "room_read"],
    category: "students",
  },
  view_student_rooms: {
    displayName: "View Student Rooms",
    dependencies: ["student_read"],
    category: "students",
  },
  export_student_data: {
    displayName: "Export Student Data",
    dependencies: ["student_read"],
    category: "students",
    isHighPrivilege: true,
  },
  ...
  visitor_create: {
    displayName: "Create Visitor Logs",
    dependencies: ["visitor_read"],
    category: "visitors",
  },
  visitor_update: {
    displayName: "Update Visitor Logs",
    dependencies: ["visitor_read"],
    category: "visitors",
  },
  visitor_delete: {
    displayName: "Delete Visitor Logs",
    dependencies: ["visitor_read"],
    category: "visitors",
    isHighPrivilege: true,
  },
  export_visitor_data: {
    displayName: "Export Visitor Logs",
    dependencies: ["visitor_read"],
    category: "visitors",
    isHighPrivilege: true,
  },
  ...
  view_complaint_stats: {
    displayName: "View Complaint Stats",
    dependencies: ["complaint_read"],
    category: "complaints",
  },
  export_complaint_data: {
    displayName: "Export Complaint Data",
    dependencies: ["complaint_read"],
    category: "complaints",
    isHighPrivilege: true,
  },
  ...
  manage_all_hostels: {
    displayName: "Manage All Hostels",
    dependencies: ["manage_system"],
    category: "system",
    isHighPrivilege: true,
  },
  view_system_stats: {
